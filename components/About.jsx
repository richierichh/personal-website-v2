    ...
    <Image className='rounded-full h-60 w-60 object-cover object-center' src={selfie} alt="Richard's profile picture" />
        ...
        <div className='mx-auto max-w-3xl px-4 sm:px-6 md:max-w-3xl text-xl pt-10'>
            <div>
                ...
                <p className='pb-6'>I am also looking for Winter 2024 internships in software engineering! Feel free to email me at richardliao2002@gmail.com or click the Contact Me button on the home page.</p>
            </div>
        </div>
    </section>
  )
